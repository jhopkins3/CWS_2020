...
#### We will use RStudio Cloud exclusively in this course, but all work can be reproduced in R and RStudio.
...
Slides: https://gkhimesboor.github.io/CWS_2020/Slides/Module1.html

Exercises and groupwork: https://rstudio.cloud/spaces/80870/project/1497680

Code to reproduce slides: https://github.com/gkhimesboor/CWS_2020/blob/master/Slides/Module1.Rmd
...
A function takes one or more arguments and does some stuff to it, then provides some output. (**x** is the argument in the functions below)  

```{r}
length(x) #returns number of values in object x (in this case it’s a vector)
print(x) #returns values or characters in object x
...
- Source code for slides and all analyses available for download at: https://github.com/gkhimesboor/CWS_2020
