...
Slides: https://gkhimesboor.github.io/CWS_2020/Slides/Module6.html

Exercises and groupwork: https://rstudio.cloud/spaces/80870/project/1497685

Code to reproduce slides: https://github.com/gkhimesboor/CWS_2020/blob/master/Slides/Module6.Rmd
...
OK, `LifeSpan` is marginally significant
```{r, echo=F}
...
But this won't let us compare more than two models or models that aren't nested!
---
# Adjusted $R^2$
...
3. Use the fits to predict the test data, calculating Root Mean Square Error (RMSE)
...
.footnote[[Cavanauh, J.E. and Neath, A.A. (2019) The Akaike information criterion: Background, derivation, properties, application, interpretation, and refinements. Wiley Interdisciplinary Reviews](https://onlinelibrary.wiley.com/doi/full/10.1002/wics.1460)]
...
* Rules of thumb for support of suboptimal model using $\Delta$AIC
  * 0- 7: plausible
  * 7-14: equivocal
  * $>$ 14: impossible
  
.footnote[[Burnham, Anderson, Huyvaert (2011) Behavioral Ecology and Sociobiology](https://link.springer.com/article/10.1007/s00265-010-1029-6)]
---
...
* Mark Brewer talk: [Model selection and the cult of AIC](https://www.youtube.com/watch?v=lEDpZmq5rBw)
* R package `caret` for cross-validation (**C**lassification **A**nd **RE**gression **T**raining)
* R package `MuMIn` for model averaging
* Some issues with using model averaging for explanatory modeling are discussed in [Cade, B. S. (2015). Model averaging and muddled multimodel inferences. Ecology, 96(9), 2370-2382.](https://esajournals.onlinelibrary.wiley.com/doi/abs/10.1890/14-1639.1)
